        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <span className="absolute -top-1 -right-0.5 bg-red-50 w-2 h-2 rounded-full border-2 border-[#1E4D8C]"></span>
            </div>
        ...
        >
          ...
          <div className="flex gap-2">
            <div className="flex-1 bg-gray-50 rounded-lg px-3 py-2 flex items-center border border-gray-100">
              <span className="text-[10px] text-gray-500 font-bold uppercase tracking-tight">Tap to search for services</span>
            </div>
            <button className="bg-[#1E4D8C] text-white px-5 py-2 rounded-lg font-bold text-xs shadow-md">
              Search
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 active:bg-gray-50 transition-colors">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-blue-50 flex items-center justify-center text-blue-600 font-bold text-xs">S</div>
              <div>
      ...
      <div className="px-4 mt-16  mb-8">
        ...
        <div className="flex gap-4 overflow-x-auto pb-4 no-scrollbar -mx-4 px-4 snap-x">
          {salons.length > 0 ? (
            ...
            <div className="w-full text-center py-10 text-gray-400 text-xs">
              {isLoading ? "Fetching salons..." : "No salons found in your area."}
            </div>
          )}
        </div>
      </div>
