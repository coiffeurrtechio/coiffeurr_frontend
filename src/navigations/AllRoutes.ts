...
const routes: AppRoute[] = [
  // ✅ Public (with header/footer)
  {
    ...
    children: [
      ...
      { key: 15, path: "/salons/:salonId", Element: SingleSalonPage, isProtected: false },
      // { key: 16, path: "/salonRegistration", Element: SalonRegistrationForm, isProtected: true },
      { key: 17, path: "/salon/:salonId/service/:serviceId", Element: SalonService, isProtected: false },
      // { key: 18, path: "/salonowner", Element: SalonOwnerHomePage, isProtected: true },
      { key: 19, path: "/search", Element: SearchPage, isProtected: false },
